...
// BuildSetupRequest instantiates a HTTP request object with method and path
// set to call the "task" service "setup" endpoint
func (c *Client) BuildSetupRequest(ctx context.Context, v any) (*http.Request, error) {
	u := &url.URL{Scheme: c.scheme, Host: c.host, Path: SetupTaskPath()}
	req, err := http.NewRequest("POST", u.String(), nil)
	if err != nil {
		return nil, goahttp.ErrInvalidURL("task", "setup", u.String(), err)
	}
	if ctx != nil {
...
// EncodeSetupRequest returns an encoder for requests sent to the task setup
// server.
func EncodeSetupRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
	return func(req *http.Request, v any) error {
		p, ok := v.(*task.SetupTaskInput)
		if !ok {
			return goahttp.ErrInvalidType("task", "setup", "*task.SetupTaskInput", v)
		}
		{
...
// DecodeSetupResponse returns a decoder for responses returned by the task
// setup endpoint. restoreBody controls whether the response body should be
// restored after having been read.
// DecodeSetupResponse may return the following errors:
//   - "Unauthorized" (type *goa.ServiceError): http.StatusUnauthorized
//   - "InternalServerError" (type *goa.ServiceError): http.StatusInternalServerError
//   - error: internal error
func DecodeSetupResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		...
		case http.StatusUnauthorized:
			...
			if err != nil {
				return nil, goahttp.ErrDecodingError("task", "setup", err)
			}
			err = ValidateSetupUnauthorizedResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("task", "setup", err)
			}
			return nil, NewSetupUnauthorized(&body)
		case http.StatusInternalServerError:
			...
			err = ValidateSetupInternalServerErrorResponseBody(&body)
			if err != nil {
				return nil, goahttp.ErrValidationError("task", "setup", err)
			}
			return nil, NewSetupInternalServerError(&body)
		default:
			body, _ := io.ReadAll(resp.Body)
			return nil, goahttp.ErrInvalidResponse("task", "setup", resp.StatusCode, string(body))
		}
	}
}
